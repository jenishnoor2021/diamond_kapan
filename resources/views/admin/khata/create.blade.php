...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-items-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">ADD Khata</h4>
   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            {!! Form::open(['method'=>'POST', 'action'=> 'AdminKhataController@store','files'=>true,'class'=>'form-horizontal','name'=>'addkhataform']) !!}
            @csrf
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <div class="mb-3">
                     <label for="party_code" class="form-label">Khata Code</label>
