...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0 font-size-18">Income Expence Summary</h4>
...
<form method="GET" action="{{ route('admin.summary') }}" class="card p-3 mb-3">
  <div class="row">
    ...
    <div class="col-md-3 mt-4">
      ...
      <a href="{{ route('admin.summary') }}" class="btn btn-secondary">Reset</a>
    </div>
