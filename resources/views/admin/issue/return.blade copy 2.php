        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              @if(request('designation') == 'Certificate')
              <th>Color</th>
              <th>Shape</th>
              <th>Cut</th>
              @endif
          ...
          <tbody>
            ...
            <tr>
              <form method="POST" action="{{ route('admin.return.store') }}">
                ...
                @if(request('designation') == 'Certificate')
                <td><input name="r_color" class="form-control"></td>
                <td><input name="r_shape" class="form-control"></td>
                <td><input name="r_cut" class="form-control"></td>
                @endif
